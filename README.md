...
基于 Figma 设计稿生成的移动端 React 应用

## 📱 项目概述

这是一个名为"寻梦星球"的移动端应用界面，基于 Figma 设计稿 (https://www.figma.com/design/F6zKuVuPaRE5hDRRsdrOEG/寻梦星球) 生成的 React 组件。

## 🎨 设计来源

- **Figma 文件**: 寻梦星球设计稿
- **节点ID**: 102-2
- **主要页面**: 寻梦星球主页面 (375x812px)
- **设计风格**: iOS 风格移动应用
